             ...
             <div className="text-center space-y-4 mb-10">
                 ...
                 <div className="text-lg">
                     ...
                     <div className="flex justify-between items-center max-w-4xl mx-auto px-12">
                         ...
                         <h2 className="text-xl font-bold uppercase tracking-wider pl-8 text-black">DUTY CHART</h2>
             ...
             <table className="w-full border-collapse border border-black text-sm text-center mb-12">
                 <thead>
                     <tr>
                         ...
                         <th className="border border-black font-normal py-2 w-48" rowSpan={2}>Date</th>
                         {dates.map((d) => (
                  ...
                  <table className="w-full text-sm min-w-[800px]">
                      <thead>
                          <tr>
                              ...
                              <th className="p-2 border bg-slate-50 w-48 text-center">Date</th>
                              {dates.map((d) => (
